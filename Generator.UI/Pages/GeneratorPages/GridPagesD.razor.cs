...
namespace Generator.UI.Pages.GeneratorPages
{
	...
	public partial class GridPagesD : PagesBase<PAGES_M,PAGES_D, IPagesDService>
    {
        ...
        public IGenView<PAGES_D> currentpage;
        ...
        public async Task OnLoadAsync(IGenView<PAGES_D> page)
        {
        ...
        public async Task CreateAsync(PAGES_D model)
        {
            var result = await Service.CreateAsync(new RESPONSE_REQUEST<PAGES_D>(model));
        ...
        public async Task UpdateAsync(PAGES_D model)
        {
            var result = await Service.UpdateAsync(new RESPONSE_REQUEST<PAGES_D>(model));

            DataSource.Replace(model, result.Data);
        }

        public async Task DeleteAsync(PAGES_D model)
        {
            var result = await Service.DeleteAsync(new RESPONSE_REQUEST<PAGES_D>(model));
